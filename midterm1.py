...
proid = Entry(root)
proid.place(x=280, y=10)

proname = Entry(root)
proname.place(x=280, y=40)

proprice = Entry(root)
proprice.place(x=280, y=80)
...
stid = Entry(root)
stid.place(x=740, y=10)

stname = Entry(root)
stname.place(x=740, y=40)

stphone = Entry(root)
stphone.place(x=740, y=80)
