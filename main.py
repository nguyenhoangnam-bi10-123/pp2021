...
def search_product():
    ...
    search_products.geometry("500x150")
...
def TAKEVALUE(event):
    ...
    y.delete(0, END)
    z.delete(0, END)
    row_id = Table_product.selection()[0]
    select = Table_product.set(row_id)
...
def ADDSTAFF():
    ...
    try:
        sql = "insert into staff (id,name,phone,address) values (%s,%s,%s,%s) "
...
def EDITSTAFF():
    ...
    try:
        sql = "Update staff set name = %s, phone = %s , address = %s where id = %s"
        value = (name, phone, address, id)
        mycursor.execute(sql, value)
        mysqldb.commit()
...
def search_staff():
    ...
    search_staffs.geometry("500x150")
...
def TAKEVALUE2(event):
    ...
    o.delete(0, END)
    p.delete(0, END)
    row_id = Table_staff.selection()[0]
    select = Table_staff.set(row_id)
...
def search_customer():
    ...
    search_customers.geometry("500x150")
...
Label(root, text="Product id",bg="#FFFFCC").place(x=160, y=10)
Label(root, text="Product name",bg="#FFFFCC").place(x=160, y=40)
Label(root, text="Product price",bg="#FFFFCC").place(x=160, y=80)
Label(root, text="Product content",bg="#FFFFCC").place(x=160, y=120)

a = Entry(root,bg="#A9A9A9")
a.place(x=280, y=10)

x = Entry(root,bg="#A9A9A9")
x.place(x=280, y=40)

y = Entry(root,bg="#A9A9A9")
y.place(x=280, y=80)

z = Entry(root,bg="#A9A9A9")
z.place(x=280, y=120)
...
Label(root, text="Staff id",bg="#FFFFCC").place(x=620, y=10)
Label(root, text="Staff name",bg="#FFFFCC").place(x=620, y=40)
Label(root, text="Staff phone",bg="#FFFFCC").place(x=620, y=80)
Label(root, text="Staff address",bg="#FFFFCC").place(x=620, y=120)

t = Entry(root,bg="#A9A9A9")
t.place(x=740, y=10)

u = Entry(root,bg="#A9A9A9")
u.place(x=740, y=40)

o = Entry(root,bg="#A9A9A9")
o.place(x=740, y=80)

p = Entry(root,bg="#A9A9A9")
p.place(x=740, y=120)
...
Label(root, text="Customer phone",bg="#FFFFCC").place(x=1100, y=40)
Label(root, text="Product buy",bg="#FFFFCC").place(x=1100, y=80)
Label(root, text="Date buy",bg="#FFFFCC").place(x=1100, y=120)

csname = Entry(root,bg="#A9A9A9")
csname.place(x=1250, y=10)

csphone = Entry(root,bg="#A9A9A9")
csphone.place(x=1250, y=40)

cspro = Entry(root,bg="#A9A9A9")
cspro.place(x=1250, y=80)

csdate = Entry(root,bg="#A9A9A9")
...
tree_framecs.place(x=780,y=300)
...
#exit btn
exitButton = Button(root, text="Exit", command=root.destroy,bg="red", height=2, width=8).place(x=20, y=750)
